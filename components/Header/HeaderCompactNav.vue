...
<template>
  <DialogRoot>
    ...
    <DialogPortal>
      <DialogOverlay class="fixed inset-0 z-1 bg-black/50 data-[state=open]:animate-fade-in animate-duration-100!" />
      <DialogContent
        class="fixed right-0 top-0 z-1 h-100dvh max-w-full overflow-y-auto bg-#6A49AA p-4 pr-16 shadow data-[state=closed]:animate-slide-out-right data-[state=open]:animate-slide-in-right animate-duration-100! focus:outline-none"
      >
        <DialogClose
